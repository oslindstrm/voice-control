...
public class RuntimeConverter : MonoBehaviour
{
    #region Internal utilities
        ...
        public static PointCloudData ConvertToPointCloudData(string path)
        {
            try
            {
        ...
        private static BakedPointCloud ImportAsBakedPointCloud(string path)
        {
            try
            {
                var stream = File.Open(path, FileMode.Open, FileAccess.Read, FileShare.Read);
